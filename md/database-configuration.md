...
The first step in configuring Bonita BPM with your RDBMS is to create the new databases (i.e. schemas): one for engine data and platform configuration, another one, optionally, if you use business data. 
